...
public class SearchTheHouseHandler(ICommandSerializer requestSerializer, IGameController controller, TcpSession session) : 
    GameMessageHandler(requestSerializer, controller, session)
{
    protected override void Process()
    {
        ...
        {
            SearchTheHouseResultBinarySerializer serializer = new SearchTheHouseResultBinarySerializer();
